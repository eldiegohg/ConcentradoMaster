                                    ...
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <div class="panel-title">
                                                ...
                                                $qery = "SELECT   tblstudents.StudentName,tblstudents.Matricula,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,tblclasses.ClassName,tblclasses.Section from tblstudents join tblclasses on tblclasses.id=tblstudents.ClassId where tblstudents.Matricula=:matricula and tblstudents.ClassId=:classid ";
                                                ...
                                                if ($stmt->rowCount() > 0) {
                                                    foreach ($resultss as $row) {   ?>
                                                        ...
                                                        <p><b>Matricula:</b> <?php echo htmlentities($row->Matricula); ?>
                                                        <p><b>Grupo:</b> <?php echo htmlentities($row->ClassName); ?>(<?php echo htmlentities($row->Section); ?>)
                                                        <?php }
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <table class="table table-hover table-bordered" border="1" width="100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $query = "select t.StudentName,t.Matricula,t.ClassId,t.marks,SubjectId,tblsubjects.SubjectName from (select sts.StudentName,sts.Matricula,sts.ClassId,tr.marks,SubjectId from tblstudents as sts join  tblresult as tr on tr.StudentId=sts.StudentId) as t join tblsubjects on tblsubjects.id=t.SubjectId where (t.Matricula=:matricula and t.ClassId=:classid)";
                                                        ...
                                                        <?php
                                                            ...
                                                            <?php
                                                            echo htmlentities("Matricula inválida");
                                                        }
                                                            ?>
                                                            </div>
                                                    </tbody>
