...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $roolid = $_POST['matricula'];
        $studentemail = $_POST['emailid'];
        $gender = $_POST['gender'];
        $classid = $_POST['class'];
        $dob = $_POST['dob'];
        $status = $_POST['status'];
        $sql = "update tblstudents set StudentName=:studentname,Matricula=:matricula,StudentEmail=:studentemail,Gender=:gender,DOB=:dob,Status=:status where StudentId=:stid ";
                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $result) {  ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="matricula" class="form-control" id="matricula" value="<?php echo htmlentities($result->Matricula) ?>" maxlength="8" required="required" autocomplete="off">
                                                    </div>
                                                </div>
