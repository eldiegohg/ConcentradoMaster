        ...
        <div class="login-bg-color">
            <div class="row">
                <div class="col-md-4 col-md-offset-7">
                    <div class="panel login-box" style="background: #006400;">
                        <div class="panel-heading">
                            <div class="panel-title text-center">
                                <a href="#">
                                    <img style="height: 70px" src=""></a>
                                <h3 class="text-uppercase text-white">Verifica tus Resultados</h3>
                            </div>
                        </div>
                        <div class="panel-body p-20">
                            ...
                            <form action="result.php" method="post" class="admin-login">
                                <div class="form-group">
                                    <label for="matricula" class="control-label">Ingresa tu Matricula</label>
                                    <input type="text" class="form-control" id="matricula" placeholder="Ingresa tu Matricula" autocomplete="off" name="matricula">
                                </div>
                                <div class="form-group">
